			...
			<div class="container position-relative">
				<div class="site-navigation text-center dark">
					...
					<div class="menu-icons">
						...
						<!--  유저 버튼 -->
						<a href="#" class="user-profile"> <svg width="1em"
										...
										<div class="row">
											<div class="col-6 col-sm-6 col-md-6 mb-4 col-lg-4">
												<div class="product-item">
													<!-- 게시판 틀 -->
													<form action="deleteGoods.do" class="col-md-8"
														method="post">
														<table class="table table-bordered">
															

															<tr>
																<th bgcolor="#f8f9fa">상품 번호</th>
																<th bgcolor="#f8f9fa">상품명</th>
																<th bgcolor="#f8f9fa">상품 사진</th>
																<th bgcolor="#f8f9fa">카테고리</th>
																<th bgcolor="#f8f9fa">가격</th>
																<th bgcolor="#f8f9fa">수량</th>
																<th bgcolor="#f8f9fa">등록 날짜</th>
																<th bgcolor="#f8f9fa">삭제</th>
															</tr>
															<c:forEach items="${goodsList}" var="goods">
																<tr>
																	<td>${goods.g_Id}</td>
																	<td><a href="getGoods.do?g_Id=${goods.g_Id }">${goods.g_Name}</a></td>
																	<td class="product-thumbnail"><a
																		href="getGoods.do?g_Id=${goods.g_Id }"> <c:choose>
																				<c:when test="${goods.g_Size1==0}">첨부파일 없음</c:when>
																				<c:otherwise>
																					<img
																						src="<%=pjName %>/resources/images/upload/${goods.gl_Img1}"
																						width='150' height='100'>${goods.g_Img1}
					   															</c:otherwise>
																			</c:choose>
																	</a></td>
																	<td>${goods.sc_Id}</td>
																	...
																	<td><a href="deleteGoods.do?g_Id=${goods.g_Id }"><input type="button" id='bnt'
