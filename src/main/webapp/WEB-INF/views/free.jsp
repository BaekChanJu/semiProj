    ...
    <div class="container">
      <div class="row align-items-end text-center">
        <div class="col-lg-7 mx-auto">
          <h1>자유 게시판</h1>  
          <p class="mb-4"><a href="index.jsp">Home</a> / <strong>자유 게시판</strong></p>        
        </div>
      </div>
    </div>
  </div>
<!-- 게시판 목록 -->
  <div class="untree_co-section pt-3">
                ...
                <ul class="list-unstyled">
                  <li>
                   <c:if test="${pageMaker.prev}">
                    <a href="<%=pjName%>/free.do${pageMaker.makeQuery(pageMaker.startPage - 1)}&g_cid =${g_cid}">
    ...
    <c:forEach begin="${pageMaker.startPage}" end="${pageMaker.endPage}" var="idx">
    	<li><a href="<%=pjName%>/free.do${pageMaker.makeQuery(idx)}&g_cid =${g_cid}">${idx}</a></li>
    </c:forEach>
                  <li>
                     <c:if test="${pageMaker.next && pageMaker.endPage > 0}">
                    <a href="<%=pjName%>/free.do${pageMaker.makeQuery(pageMaker.endPage + 1)}&g_cid =${g_cid}">
