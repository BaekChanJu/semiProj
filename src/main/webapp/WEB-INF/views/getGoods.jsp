				...
				<div class="col-md-9">
					<div class="row">
						<div class="col-12 col-sm-12 col-md-12 mb-12 col-lg-12">
							...
							<form action="updateGoods.do" role="form" method='post' enctype="multipart/form-data" autocomplete="off">
								...
								<div class="inputArea">
									...
									<input type="text" id="g_Name" name="g_Name" value='${goods.g_Name}'/>
								</div>
								<div class="inputArea">

									<label for="gdsPrice">상품가격</label> 
									<input type="text"id="g_Price" name="g_Price" value='${goods.g_Price}'/>
								</div>

								<div class="inputArea">
									<label for="g_Stock">상품수량</label> 
									<input type="text" id="g_Stock" name="g_Stock" value='${goods.g_Stock}'/>

								</div>

								<div class="col-md-12 mb-3 mb-md-0">
									<td bgcolor="orange" width="70">상품 이미지 첨부</td>
									<td><input type="file" id="g_img1" multiple="multiple" name='file1' class="btn btn-outline-black btn-sm btn-block" maxlength="60" size="40">
									등록된 이미지 : ${goods.g_Img1}
									<img src="<%=pjName %>/resources/images/upload/${goods.gl_Img1}" width='150' height='100'>
									</td>
									<td><input type="file" id="g_img1" multiple="multiple" name='file2' class="btn btn-outline-black btn-sm btn-block" maxlength="60" size="40">
									등록된 이미지 : ${goods.g_Img2}
									<img src="<%=pjName %>/resources/images/upload/${goods.gl_Img2}" width='150' height='100'>
									</td>
									<div>
									<td><input type="file" id="g_img1" multiple="multiple" name='file3' class="btn btn-outline-black btn-sm btn-block" maxlength="60" size="40">
									등록된 이미지 : ${goods.g_Img3}                       
									<img src="<%=pjName %>/resources/images/upload/${goods.gl_Img3}" width='300' height='100'>
									</td>
								</div>
								...
								<div class="inputArea">
									...
									<textarea rows="10" cols="107" id="g_Message" name="g_Message" >${goods.g_Message}</textarea>
								</div><br/>


								<div class="inputArea">
									<input type="submit" id='bnt' class="btn btn-outline-black btn-sm btn-block" value="수정"><br/>
								</div>
							</form>
						</div>
					</div>
