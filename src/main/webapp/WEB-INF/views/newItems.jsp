        ...
        <div class="col-md-3">
          ...
          <c:set var="count" value="1" />
           ...
           <c:forEach items="${newList}" var="newItem">
                ...
                <td><a href="goodsPage.do?g_Id=${newItem.g_Id}" class="product-img">
                  <img src="<%=pjName%>/resources/images/upload/${newItem.gl_Img1} " width="280" height="280">
                </a><br/>
                <h3 class="title"><a href="#"><div id = "css">${newItem.g_Name}</div></a></h3>
                  <span>${newItem.g_Price}</span>
                </td>
                <c:if test="${count %3 ==0}">
                </tr><tr>
