    ...
    <div class="container">
      <div  class="row align-items-end text-center">
        ...
        <div class="col-lg-7 mx-auto">
          <!-- 이름대신 배너 넣음 -->
           <h1>StyleReview</h1>  
          <p class="mb-4"><a href="index.do">Home</a> / <strong>StyleReview</strong></p>        
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="untree_co-section pt-3">
    <div class="container">
        ...
        <input type="hidden" name='s_id' value='${style.s_id}'>
          <br/><br/>
          <input  type="text" id="s_title" name="s_title" value='${style.s_title}' > <br/><br/>
        
         <img src="<%=pjName %>/resources/images/upload/${style.s_img}"  width="580" height="650"><br/><br/>

  		<textarea rows="10" cols="100" id="s_message"  class="form-control" style="border: none" name="s_message">${style.s_message}</textarea>
    
    	<input id="modi" type= "submit" class='btn btn-outline-black btn-sm' value="수정"/>
    	<a href="styledelete.do?s_id=${style.s_id}">
    	  <input id="modi" type= "button" class='btn btn-outline-black btn-sm' value="삭제"/>
    	 </a>
</form>
