    ...
    <div class="container">
      <div class="row align-items-end text-center">
        <div class="col-lg-7 mx-auto">
          <h1>자유 게시판 글쓰기</h1>  
          <p class="mb-4"><a href="index.jsp">Home</a> / <strong>글작성</strong></p>        
        </div>
      </div>
    </div>
  </div>
<!-- 게시판 목록 -->
  ...
  <div class="untree_co-hero" style="background-image: url('resources/images/write1.gif');">
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-md-9">
          <div class="row">
			...
			<!-- free게시판 글작성 -->
			<form action="writeon1.do" method="post">
   			 <table id="gtext" >
        <tr>
            <td><input type="text" name="f_title" id="f_title" placeholder="제목" required/></td>
        </tr>
        <tr>
            <td><textarea name="f_message" id="f_message" cols="73" rows="10"  placeholder="내용" required></textarea></td>
        </tr>
        <tr>
            <td><input type="password" name="f_pass" id="f_pass" placeholder="패스워드" required/></td>
        </tr>
        <tr>
            <td colspan="2">
                <button type="submit" id="button">작성</button>
            </td>
        </tr>
    </table>
</form>
