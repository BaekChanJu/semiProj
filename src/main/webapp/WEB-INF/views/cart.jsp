  ...
  <div class="untree_co-section">
    <div class="container">
                ...
                <tr>
                  ...
                  <td>${cart.g_Price}</td>
                    ...
                    <div class="input-group mb-3" style="max-width: 120px;">
                      ...
                      <a href="minCart.do?m_Id=${cart.m_Id}&g_Id=${cart.g_Id}" class="btn btn-outline-black " >
                        &minus;
                      </a>
                      </div>
                      ...
                      <div class="input-group-append">
                        <a href="plusCart.do?m_Id=${cart.m_Id}&g_Id=${cart.g_Id}" class="btn btn-outline-black ">&plus;</a>
                      </div>
                    </div>
      ...
      <!--  클릭시 전체삭제,쇼핑더하기  -->
        ...
        <div class="col-md-6">
        <form action="deleteAllCart.do" name='deleteAllCart'>
        <input type="hidden" name='m_Id' id='m_Id' value='${sessionScope.login}'>
        
          <div class="row mb-5">
            <div class="col-md-6 mb-3 mb-md-0">
              <input type="submit" class="btn btn-outline-black btn-sm btn-block" value='장바구니 전체 삭제'>
            </div>
            <div class="col-md-6">
            	<a href="index.do?m_Id=${sessionScope.login}" class="btn btn-outline-black btn-sm btn-block">쇼핑 계속하기</a>
            </div>
          </div>
          </form>
          <!--  클릭시 전체삭제,쇼핑더하기 종료 -->
            ...
            <div class="col-md-7">
              ...
              <div class="row mb-5">
                ...
                <br/> <br/> <br/>
                  ...
                  <span class="text-black h2 text-uppercase" id='totalPrices'></span><br/><br/>
                </div>
              </div>

              <div class="row">
                <div class="col-md-12">
                <a href="checkOut.do?m_Id=${sessionScope.login}" class="cart">
