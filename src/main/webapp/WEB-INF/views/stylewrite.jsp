					...
					<div class="row">
						<div class="col-12 col-sm-12 col-md-12 mb-12 col-lg-12">
							...
							<form action="styleInsert"  role="form" method='post' enctype="multipart/form-data" autocomplete="off">
								...
								<div class="inputArea">
									<input type="text" id="s_title" name="s_title" placeholder="제목"/><br/>
								</div>

								<div class="col-md-8 mb-3 mb-md-0">
									<td bgcolor="orange" width="70">상품 이미지 첨부</td>
									<td align="left"><input type="file" id="s_img" multiple="s_img" name='file1' class="btn btn-outline-black btn-sm btn-block" maxlength="60" size="40"></td><br/>
								</div>
									
								<div class="inputArea">
									
									 <textarea rows="10" cols="100" id="s_message" name="s_message" placeholder="상품후기"></textarea>
								</div>	
								
								<div class="inputArea">
									<input type="password" id="s_pass" name="s_pass" placeholder="비밀번호"/><br/><br/>
								</div>
